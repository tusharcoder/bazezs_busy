...
<center><p style="font-size:20px;color:red">Write in the first signature 2</p></center><br>
		...
		<center>
			<form action="operations.php" method="POST" enctype="multipart/form-data">
				<input type="hidden" name="order_id" value="<?php echo $order_id?>">
					...
					<button type="submit" id="create_signature" name="add_signature2" class="btn btn-success btn-lg" style="">Next</button>
			</form>
		</center><br><br>
