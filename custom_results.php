					...
					<div class="col-md-8">
						<div class="well" style="margin-top:-30px;">
							...
							<?php
								...
								$random_result = mysqli_query($con, "SELECT * FROM results WHERE result_type='$result_type' AND result_point=$total_points ORDER BY RAND() LIMIT 1");
							?>
							...
							<?php
								...
								while ($random_row = mysqli_fetch_array($random_result)) {
									...
									mysqli_query($con,"INSERT INTO order_results (order_id, result_name, result_image, result_id) values('$order_id','".$random_row['result_name']."','".$random_row['result_image']."',".$random_row['result_id'].")");
							?>
									<tr>
							...
							<center><div id="request_review" class="circle" style="background:orange;font-size:20px;border:none"><i class="fa fa-commenting" style="color:white !important"></i> </div> <span style="color:green">Request Expert Review </span></center>
							<br><br>
	...
	<?php
		$message ='
			...
			<table align="center" cellpadding="0" cellspacing="0" class="container-for-gmail-android" width="600px" style="margin:auto;margin-bottom:40px">
			  ...
			  <tr>
				<td style="position:relative;width: 100% !important;padding: 10px 60px 0px;font-family: Helvetica, Arial, sans-serif;font-size: 14px;color: black;text-align: left; line-height: 21px;vertical-align:middle"><img src="'.$host.'/icons/index-page/'.$random_arr_image[0].'" style="border-radius:50%">&nbsp;&nbsp;&nbsp;&nbsp;<b style="position:absolute;top:29px;left:137px;"> '.$random_arr_name[0].' </b><br><br></br></td>
			  </tr>
				<tr>
				<td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
				  <center>
